 ...
 */
export declare function publish(message: ServerPlayerItemPickup, nc: Nats.NatsConnection, codec: Nats.Codec<any>, server_id: string, steam_id: string, item_id: string, options?: Nats.PublishOptions): Promise<void>;
