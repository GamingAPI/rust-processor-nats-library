...
exports.ServerPlayerItemLoot = void 0;
class ServerPlayerItemLoot {
    ...
    get lootTimestamp() { return this._lootTimestamp; }
    set lootTimestamp(lootTimestamp) { this._lootTimestamp = lootTimestamp; }
    ...
    get containerUid() { return this._containerUid; }
    set containerUid(containerUid) { this._containerUid = containerUid; }
    get containerPrefab() { return this._containerPrefab; }
    set containerPrefab(containerPrefab) { this._containerPrefab = containerPrefab; }
    get containerPosition() { return this._containerPosition; }
    set containerPosition(containerPosition) { this._containerPosition = containerPosition; }
    ...
    static unmarshal(json) {
        ...
        const instance = new ServerPlayerItemLoot({});
...
exports.ServerPlayerItemLoot = ServerPlayerItemLoot;
//# sourceMappingURL=ServerPlayerItemLoot.js.map