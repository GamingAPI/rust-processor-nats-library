 ...
 */
/**
 * Internal functionality to setup subscription on the `v0/rust/servers/{server_id}/players/{steam_id}/events/items/{item_id}/pickup` channel
 *
...
function subscribe(onDataCallback, nc, codec, server_id, steam_id, item_id, options) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let subscription = nc.subscribe(`v0.rust.servers.${server_id}.players.${steam_id}.events.items.${item_id}.pickup`, subscribeOptions);
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    for (var subscription_1 = __asyncValues(subscription), subscription_1_1; subscription_1_1 = yield subscription_1.next(), !subscription_1_1.done;) {
                        ...
                        const unmodifiedChannel = `v0.rust.servers.{server_id}.players.{steam_id}.events.items.{item_id}.pickup`;
                        ...
                        onDataCallback(undefined, ServerPlayerItemPickup_1.ServerPlayerItemPickup.unmarshal(receivedData), serverIdParam, steamIdParam, itemIdParam);
                    }
                }
...
//# sourceMappingURL=V0RustServersServerIdPlayersSteamIdEventsItemsItemIdPickup.js.map