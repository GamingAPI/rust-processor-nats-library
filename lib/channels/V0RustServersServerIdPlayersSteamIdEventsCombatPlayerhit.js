 ...
 */
/**
 * Internal functionality to setup subscription on the `v0/rust/servers/{server_id}/players/{steam_id}/events/combat/playerhit` channel
 *
...
function subscribe(onDataCallback, nc, codec, server_id, steam_id, options) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let subscription = nc.subscribe(`v0.rust.servers.${server_id}.players.${steam_id}.events.combat.playerhit`, subscribeOptions);
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    for (var subscription_1 = __asyncValues(subscription), subscription_1_1; subscription_1_1 = yield subscription_1.next(), !subscription_1_1.done;) {
                        ...
                        const unmodifiedChannel = `v0.rust.servers.{server_id}.players.{steam_id}.events.combat.playerhit`;
                        ...
                        onDataCallback(undefined, ServerPlayerCombatPlayerhit_1.ServerPlayerCombatPlayerhit.unmarshal(receivedData), serverIdParam, steamIdParam);
                    }
                }
...
//# sourceMappingURL=V0RustServersServerIdPlayersSteamIdEventsCombatPlayerhit.js.map