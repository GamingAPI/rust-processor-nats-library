...
function subscribe(onDataCallback, nc, codec, server_id, steam_id, options) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let subscription = nc.subscribe(`v0.rust.servers.${server_id}.players.${steam_id}.events.reported`, subscribeOptions);
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    for (var subscription_1 = __asyncValues(subscription), subscription_1_1; subscription_1_1 = yield subscription_1.next(), !subscription_1_1.done;) {
                        ...
                        const unmodifiedChannel = `v0.rust.servers.{server_id}.players.{steam_id}.events.reported`;
                        ...
                        onDataCallback(undefined, ServerPlayerReported_1.ServerPlayerReported.unmarshal(receivedData), serverIdParam, steamIdParam);
                    }
                }
...
//# sourceMappingURL=V0RustServersServerIdPlayersSteamIdEventsReported.js.map