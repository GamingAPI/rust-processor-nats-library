 ...
 * rust/servers/{server_id}/players/{steam_id}/events/resourcesGathered
 * 
...
export function publish(
  ...
  return new Promise < void > (async (resolve, reject) => {
    try {
      ...
      await client.publish(`rust.servers.${server_id}.players.${steam_id}.events.resourcesGathered`, dataToSend);
      resolve();
    } catch (e) {
