 ...
 * rust/servers/{server_id}/players/{steam_id}/events/items/{item_id}/pickup
 * 
...
export function publish(
  ...
  return new Promise < void > (async (resolve, reject) => {
    try {
      ...
      await client.publish(`rust.servers.${server_id}.players.${steam_id}.events.items.${item_id}.pickup`, dataToSend);
      resolve();
    } catch (e) {
