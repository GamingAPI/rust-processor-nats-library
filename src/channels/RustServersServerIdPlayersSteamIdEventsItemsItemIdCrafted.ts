 ...
 * rust/servers/{server_id}/players/{steam_id}/events/items/{item_id}/crafted
 * 
...
export function publish(
  ...
  return new Promise < void > (async (resolve, reject) => {
    try {
      ...
      await client.publish(`rust.servers.${server_id}.players.${steam_id}.events.items.${item_id}.crafted`, dataToSend);
      resolve();
    } catch (e) {
