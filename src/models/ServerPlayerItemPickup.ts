...
class ServerPlayerItemPickup {
  ...
  get pickupTimestamp(): string { return this._pickupTimestamp; }
  set pickupTimestamp(pickupTimestamp: string) { this._pickupTimestamp = pickupTimestamp; }
  ...
  public static unmarshal(json: string | object): ServerPlayerItemPickup {
    const obj = typeof json === "object" ? json : JSON.parse(json);
    const instance = new ServerPlayerItemPickup({} as any);
...
export default ServerPlayerItemPickup;
