...
describe('rust/servers/{server_id}/players/{steam_id}/events/combat/playerhit can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsCombatPlayerhit((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsCombatPlayerhit(publishMessage, ServerIdToSend, SteamIdToSend);
