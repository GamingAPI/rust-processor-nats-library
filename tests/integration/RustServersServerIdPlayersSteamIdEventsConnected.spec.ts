...
describe('rust/servers/{server_id}/players/{steam_id}/events/connected can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsConnected((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsConnected(publishMessage, ServerIdToSend, SteamIdToSend);
