...
describe('v0/rust/servers/{server_id}/events/stopping can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToV0RustServersServerIdEventsStopping((err, msg, server_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToV0RustServersServerIdEventsStopping(publishMessage, ServerIdToSend);
