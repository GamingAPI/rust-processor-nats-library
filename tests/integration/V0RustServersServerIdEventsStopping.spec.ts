...
describe('v0/rust/servers/{server_id}/events/stopping can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await client.subscribeToV0RustServersServerIdEventsStopping((err, msg, server_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await testClient.publishToV0RustServersServerIdEventsStopping(publishMessage, ServerIdToSend);
