...
describe('rust/servers/{server_id}/players/{steam_id}/events/items/{item_id}/loot can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsItemsItemIdLoot((err, msg, server_id, steam_id, item_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsItemsItemIdLoot(publishMessage, ServerIdToSend, SteamIdToSend, ItemIdToSend);
