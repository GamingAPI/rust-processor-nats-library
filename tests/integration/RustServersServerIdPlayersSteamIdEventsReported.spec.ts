...
describe('rust/servers/{server_id}/players/{steam_id}/events/reported can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    var receivedMsg: TestClient.ServerPlayerReported | undefined = undefined;
    var receivedServerId: string | undefined = undefinedvar receivedSteamId: string | undefined = undefined
    var publishMessage: Client.ServerPlayerReported = Client.ServerPlayerReported.unmarshal({
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsReported((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsReported(publishMessage, ServerIdToSend, SteamIdToSend);
