...
describe('rust/servers/{server_id}/players/{steam_id}/events/disconnected can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsDisconnected((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsDisconnected(publishMessage, ServerIdToSend, SteamIdToSend);
