...
describe('rust/servers/{server_id}/events/stopping can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdEventsStopping((err, msg, server_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdEventsStopping(publishMessage, ServerIdToSend);
