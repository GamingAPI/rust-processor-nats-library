...
describe('v0/rust/servers/{server_id}/players/{steam_id}/events/combat/playerhit can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    var receivedMsg: TestClient.ServerPlayerCombatPlayerhit | undefined = undefined;
    var receivedServerId: string | undefined = undefinedvar receivedSteamId: string | undefined = undefined
    var publishMessage: Client.ServerPlayerCombatPlayerhit = Client.ServerPlayerCombatPlayerhit.unmarshal({
    ...
    const subscription = await testClient.subscribeToV0RustServersServerIdPlayersSteamIdEventsCombatPlayerhit((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToV0RustServersServerIdPlayersSteamIdEventsCombatPlayerhit(publishMessage, ServerIdToSend, SteamIdToSend);
