...
describe('rust/servers/{server_id}/events/wiped can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdEventsWiped((err, msg, server_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdEventsWiped(publishMessage, ServerIdToSend);
