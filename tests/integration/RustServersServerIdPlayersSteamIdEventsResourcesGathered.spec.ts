...
describe('rust/servers/{server_id}/players/{steam_id}/events/resourcesGathered can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsResourcesGathered((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsResourcesGathered(publishMessage, ServerIdToSend, SteamIdToSend);
