...
describe('rust/servers/{server_id}/events/started can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdEventsStarted((err, msg, server_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdEventsStarted(publishMessage, ServerIdToSend);
