...
describe('rust/servers/{server_id}/players/{steam_id}/events/unbanned can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsUnbanned((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsUnbanned(publishMessage, ServerIdToSend, SteamIdToSend);
