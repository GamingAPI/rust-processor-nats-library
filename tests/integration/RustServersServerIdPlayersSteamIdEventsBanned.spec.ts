...
describe('rust/servers/{server_id}/players/{steam_id}/events/banned can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsBanned((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsBanned(publishMessage, ServerIdToSend, SteamIdToSend);
