...
describe('v0/rust/servers/{server_id}/events/started can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToV0RustServersServerIdEventsStarted((err, msg, server_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToV0RustServersServerIdEventsStarted(publishMessage, ServerIdToSend);
