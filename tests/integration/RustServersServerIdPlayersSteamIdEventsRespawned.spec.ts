...
describe('rust/servers/{server_id}/players/{steam_id}/events/respawned can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsRespawned((err, msg, server_id, steam_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsRespawned(publishMessage, ServerIdToSend, SteamIdToSend);
