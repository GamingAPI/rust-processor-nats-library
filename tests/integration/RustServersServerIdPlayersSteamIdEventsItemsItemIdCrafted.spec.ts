...
describe('rust/servers/{server_id}/players/{steam_id}/events/items/{item_id}/crafted can talk to itself', () => {
  ...
  it('can send message', async () => {
    ...
    const subscription = await testClient.subscribeToRustServersServerIdPlayersSteamIdEventsItemsItemIdCrafted((err, msg, server_id, steam_id, item_id) => {
        receivedError = err;
        receivedMsg = msg;
    ...
    await client.publishToRustServersServerIdPlayersSteamIdEventsItemsItemIdCrafted(publishMessage, ServerIdToSend, SteamIdToSend, ItemIdToSend);
